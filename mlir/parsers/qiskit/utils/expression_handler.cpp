...
void qiskit_expression_generator::update_current_value(mlir::Value v) {
  last_current_value = current_value;
  current_value = v;
  return;
}

qiskit_expression_generator::qiskit_expression_generator(mlir::OpBuilder& b,
...
antlrcpp::Any qiskit_expression_generator::visitTerminal(
...
antlrcpp::Any qiskit_expression_generator::visitExpression(
    qiskitParser::ExpressionContext* ctx) {
...
//     ;
antlrcpp::Any qiskit_expression_generator::visitExpressionTerminator(
    qiskitParser::ExpressionTerminatorContext* ctx) {
