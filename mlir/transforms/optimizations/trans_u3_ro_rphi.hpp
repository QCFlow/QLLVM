...
struct trans_u3_ro_rphi
    : public PassWrapper<trans_u3_ro_rphi, OperationPass<ModuleOp>> {
  void getDependentDialects(DialectRegistry &registry) const override;
  void runOnOperation() final;
  trans_u3_ro_rphi() {}
  ~trans_u3_ro_rphi() {}
  trans_u3_ro_rphi(std::map<std::string, bool> bool_args,int &opt_count, int &opt_depth, int &cir_depth, int &zero_count, int &enable, int &pass_count) {
...
private:
  ...
  std::string passname = "trans_u3_ro_rphi";
};
} // namespace qllvm