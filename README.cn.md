...
2. 在扩展搜索框中，输入"qcflow-publisher.qcoder-chat"插件ID，搜索对应插件并点击「安装」，即自动安装 qcflow-publisher.qcoder-chat 和 qcflow-publisher.qcoder-compiler 两个插件。
3. 安装完成后，插件自动生效，可直接使用智能编程、编译及运行服务。
```
