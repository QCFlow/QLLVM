...
// Quantum kernel from qaoa_suboptimal.qasm (__internal_mlir_<stem>)
extern "C" {
void __quantum__rt__initialize(int argc, int8_t** argv);
void __quantum__rt__finalize();
void __internal_mlir_qaoa_suboptimal(void);
}
...
int main(int argc, char** argv) {
  ...
  std::cout << "Quantum kernel (3-qubit QAOA / path MaxCut, *suboptimal* angles) counts:\n";
  __internal_mlir_qaoa_suboptimal();
  ...
  std::cout << "Est. <H_C>   = 0.5*<Z0Z1> + 0.5*<Z1Z2> ≈ " << s.energy
            << "  (optimal for this problem: -1; exact with these angles ≈ +0.036)\n";
