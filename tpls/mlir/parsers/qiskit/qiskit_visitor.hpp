...
class qiskit_visitor : public qiskit::qiskitBaseVisitor {
 public:
  ...
  antlrcpp::Any visitQuantumCircuitDeclaration(qiskitParser::QuantumCircuitDeclarationContext *ctx) override;
  antlrcpp::Any visitQuantumGateCall(qiskitParser::QuantumGateCallContext *ctx) override;
  antlrcpp::Any visitQuantumMeasurement(qiskitParser::QuantumMeasurementContext *ctx) override;
